...
# NOVA FUNÇÃO: Combina animação com formatação de texto
function Write-TypingFormattedText {
    ...
    foreach ($line in $lines) {
        ...
        Write-Host "" # Adiciona uma nova linha
    }
}
...
function Start-DiagnosticAnalysis {
    ...
    $reportWidth = $windowWidth - 4 # Reverte para a largura da tela

    # --- CABEÇALHO ---
    # AJUSTE: Removido o cabeçalho duplicado para o relatório formatado.
    # Write-Host "========================================================================================================================================================================" -ForegroundColor Cyan
    # Write-Host "      ANÁLISE DO DIAGNÓSTICO" -ForegroundColor Cyan
    # Write-Host "      Análise do sistema '$($data.Hostname)' em $($data.Timestamp)" -ForegroundColor White
